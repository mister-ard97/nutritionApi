...
module.exports = {
  ...
  getDetailRecipe: (req, res) => {
    console.log(req.params.id);
    // id, material, calorie, protein, totalFat,
    //         asam, carbohydrat, fiber, iron, calcium, zinc,
    //         fosfor, natrium, kalium, magnesium, tiamin, vitb12,
    //         vit_c, vit_d, folat, price, source_url
    let sql = `select 
        rd.id, 
        rd.gram, 
        i.material,
